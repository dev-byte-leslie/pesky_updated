if (activeElement == "mainMenu") {
  window.mainMenuGroup = new PIXI.Container(); /// Parent container for ALL menu items
  window.buttonGroup = new PIXI.Container(); // Container for all the menu buttons
  window.creditsGroup = new PIXI.Container(); // Container for objects on credits screen
  window.tutorialGroup = new PIXI.Container(); // Container for objects on tutorial screen
  ...
  mainMenuGroup.addChild(creditsGroup); // TEST
  ...
  function showCredits() {
   window.activeElement = "credits";
   // buttonGroup.visible = false;
   // creditsGroup.visible = true;
  }
  function showTutorial() {
    window.activeElement = "tutorial";
  }
  function showOptions() {
    window.activeElement = "options";
  }
